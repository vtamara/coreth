...
func setupGenesis(t *testing.T,
	...
	*atomic.Memory) {
	...
	baseDBManager := manager.NewMemDB(&version.Semantic{Major: 1, Minor: 4, Patch: 5})
	...
	userKeystore := keystore.New(logging.NoLog{}, manager.NewMemDB(&version.Semantic{Major: 1, Minor: 4, Patch: 5}))
